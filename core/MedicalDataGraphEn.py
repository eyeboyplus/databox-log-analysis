...
table_meta = databox.get_relative_path('config/DataMeta.xml')
relation_meta = databox.get_relative_path('config/RelationMeta')
sensitive_meta = databox.get_relative_path('config/Protection.xml')
